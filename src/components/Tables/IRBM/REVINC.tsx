...
export function REVINC({ value }: { value: string }) {
          ...
          <thead>
            ...
            <tr>
              ...
              <th
                ...
                className="border border-gray-300 bg-white text-center text-sm font-semibold"
              >
                % Of revenue under prepaid increased from 40% to 54%
              </th>
              <th
                rowSpan={1}
                className="border border-gray-300 bg-yellow-200 p-2 text-center text-sm font-semibold uppercase"
              >
                Output Ref.:
              </th>
              <th
