...
export const metadata: Metadata = {
  title: "Next.js YearlyReports Page | NextAdmin - Next.js Dashboard c",
  description: "This is Next.js YearlyReports page for NextAdmin Dashboard Kit",
}; */
  ...
  return (
    <DefaultLayout>
      <div className="mx-auto w-full max-w-[1080px]">
        <Breadcrumb page="Reports" pageName="Yearly" />
