...
import { getAllWorkPlanByScopeId } from "@/app/actions/getWorkPlans";
 ...
 */
  ...
  const dataC = await getAllWorkPlanByScopeId(params?.taskId);
        ...
        <section className="mb-8 grid gap-4 lg:grid-cols-2">
          ...
          <div className="rounded-md bg-white p-4 shadow-md">
            ...
            <div className="mt-2 h-3 w-full rounded-lg bg-gray-200">
              <div
                className={`h-3 rounded-lg ${overdue ? "bg-red-500" : "bg-blue-600"} `}
        ...
        <section className="mb-8 rounded-md bg-white p-4 shadow-md">
          ...
          <div className="relative">
            ...
            <div className="mx-auto flex h-32 w-32 items-center justify-center rounded-full bg-gray-200">
              ...
              <CircularProgress
                percentage={data.percentageComplete || 0}
                overdue={overdue}
              />
            </div>
